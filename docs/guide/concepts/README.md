...
work to be done; a [[Context]] is one run of it. [[Actor]]s live at workspace level and
are assigned into working spaces. An [[Event]] lands and wakes things. That's the whole
shape — everything else is detail.
...
| [[Context]] | One run of a node — where work happens and outcomes appear. |
